...
function App() {
  // Track a page view for the main App component
  useEffect(() => {
    appInsights.trackPageView({ name: 'App Component' });
  }, []);
        ...
        <AuthProvider>
          <LobbyProvider> 
            <Routes>
              ...
              <Route path="/game/:lobbyId" element={<PrivateRoute><Game /></PrivateRoute>} />
